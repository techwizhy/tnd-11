...
function initPopout3dCardTilt(){const cards=document.querySelectorAll('.popout-card');cards.forEach(card=>{const bg=card.querySelector('.popout-card-bg'),info=card.querySelector('.popout-card-info');card.addEventListener('mousemove',e=>{const rect=card.getBoundingClientRect(),x=e.clientX-rect.left,y=e.clientY-rect.top,px=(x/rect.width)-0.5,py=(y/rect.height)-0.5,rotateY=px*12,rotateX=-py*12,isDark=document.documentElement.classList.contains('dark-theme'),activeBgShadow=isDark?'rgba(0,0,0,0.4)':'rgba(15,58,52,0.12)';card.style.transform=`perspective(1000px) rotateY(${rotateY}deg) rotateX(${rotateX}deg)`;card.style.transition='transform 0.1s ease-out';if(bg){bg.style.boxShadow=`0 35px 70px ${activeBgShadow}, 0 0 40px rgba(212,164,55,0.35)`;bg.style.borderColor=`rgba(212,164,55,0.45)`;bg.style.transition='box-shadow 0.1s ease-out, border-color 0.3s ease';}if(info){info.style.boxShadow=`0 15px 30px rgba(0,0,0,0.12), 0 0 20px rgba(212,164,55,0.15)`;info.style.transition='box-shadow 0.1s ease-out';}});card.addEventListener('mouseleave',()=>{card.style.transform='perspective(1000px) rotateY(0deg) rotateX(0deg)';card.style.transition='transform 0.8s cubic-bezier(0.16, 1, 0.3, 1)';if(bg){bg.style.boxShadow='0 15px 35px rgba(0,0,0,0.1)';bg.style.borderColor='rgba(255, 255, 255, 0.7)';bg.style.transition='box-shadow 0.8s cubic-bezier(0.16, 1, 0.3, 1), border-color 0.8s ease';}if(info){info.style.boxShadow='0 10px 25px rgba(0,0,0,0.05)';info.style.transition='box-shadow 0.8s cubic-bezier(0.16, 1, 0.3, 1)';}});});}
